...
module github.com/codesjoy/yggdrasil-ecosystem/modules/otlp/v3/examples

go 1.25.7

replace github.com/codesjoy/yggdrasil-ecosystem/modules/otlp/v3 => ..

require (
	github.com/codesjoy/yggdrasil-ecosystem/modules/otlp/v3 v3.0.0
