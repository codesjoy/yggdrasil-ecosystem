module github.com/codesjoy/yggdrasil-ecosystem/integrations/polaris/v2/example

go 1.25.7

replace github.com/codesjoy/yggdrasil-ecosystem/integrations/polaris/v2 => ../

replace github.com/codesjoy/yggdrasil-ecosystem/examples/protogen => ../../../examples/protogen
